...
/* Solution #2 - don't need else if since need to return anyway */
function finalGrade(exam, numProjects) {
    if (exam > 90 || numProjects > 10) {
        return 100;
    }

    if (exam > 75 && numProjects >= 5) {
        return 90;
    }

    if (exam > 50 && numProjects >= 2) {
        return 75;
    }
...
//     if (exam > 90 || numProjects > 10) {
//         return 100;
//     } else if (exam > 75 && numProjects >= 5) {
//         return 90;
//     } else if (exam > 50 && numProjects >= 2) {
//         return 75;
//     } else {
//         return 0;
//     }

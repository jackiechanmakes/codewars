...
// Test cases
console.log(findEqualIndex([1,2,3,4,3,2,1]));         // 3
console.log(findEqualIndex([1,100,50,-51,1,1]));      // 1
console.log(findEqualIndex([1,2,3,4,5,6]));           // -1
console.log(findEqualIndex([20,10,30,10,10,15,35]));  // 3
